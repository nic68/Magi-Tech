...
public class BottledManaItem extends MagiTechElements.ModElement {
	@ObjectHolder("magitech:bottledmana")
	public static final Item block = null;
	public BottledManaItem(MagiTechElements instance) {
		super(instance, 2);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Mana extracted from magical flowers"));
		}
	}
}
