...
public class ManaFlowerBlock extends MagiTechElements.ModElement {
	@ObjectHolder("magitech:manaflower")
	public static final Block block = null;
	public ManaFlowerBlock(MagiTechElements instance) {
		super(instance, 1);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			biome.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
					Biome.createDecoratedFeature(feature, IFeatureConfig.NO_FEATURE_CONFIG, Placement.COUNT_HEIGHTMAP_32, new FrequencyConfig(35)));
		}
	}
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS, MaterialColor.LIGHT_BLUE).doesNotBlockMovement()
					.sound(SoundType.PLANT).hardnessAndResistance(0f, 0f).lightValue(3));
