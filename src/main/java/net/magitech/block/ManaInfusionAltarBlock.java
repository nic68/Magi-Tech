...
public class ManaInfusionAltarBlock extends MagiTechElements.ModElement {
	@ObjectHolder("magitech:manainfusionaltar")
	public static final Block block = null;
	@ObjectHolder("magitech:manainfusionaltar")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public ManaInfusionAltarBlock(MagiTechElements instance) {
		super(instance, 4);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("manainfusionaltar"));
	}
	public static class CustomBlock extends Block {
		public static final DirectionProperty FACING = HorizontalBlock.HORIZONTAL_FACING;
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1f, 15f).lightValue(2).harvestLevel(1)
					.harvestTool(ToolType.PICKAXE));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH));
			setRegistryName("manainfusionaltar");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Mana Infusion Altar");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new ManaInfusionGUIGui.GuiContainerMod(id, inventory,
	...
	public static class CustomTileEntity extends LockableLootTileEntity {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("manainfusionaltar");
		}
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new ManaInfusionGUIGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
