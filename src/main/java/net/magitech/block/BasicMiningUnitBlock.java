...
import net.magitech.procedures.BasicMiningUnitRedstoneOnProcedure;
...
public class BasicMiningUnitBlock extends MagiTechElements.ModElement {
	@ObjectHolder("magitech:basicminingunit")
	public static final Block block = null;
	public BasicMiningUnitBlock(MagiTechElements instance) {
		super(instance, 28);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("basicminingunit");
		}
			...
			if (world.getRedstonePowerFromNeighbors(new BlockPos(x, y, z)) > 0) {
				{
					...
					BasicMiningUnitRedstoneOnProcedure.executeProcedure($_dependencies);
				}
			} else {
			}
		}
